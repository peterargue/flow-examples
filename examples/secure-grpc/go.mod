module github.com/peterargue/flow-examples/examples/secure-grpc

go 1.17

require github.com/onflow/flow-go v0.24.7
...
require (
	...
	github.com/onflow/flow/protobuf/go/flow v0.2.4-0.20220304041411-6d91cd04a33a // indirect
